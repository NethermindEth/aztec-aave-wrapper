...
```markdown
I'll start by reading the specification document to understand the full requirements, then create a comprehensive implementation plan.
Now let me explore the reference implementations mentioned in the spec to understand the patterns better. I'll also check for current Aztec documentation and tooling versions.
Excellent! Now I have a comprehensive understanding of the specification and patterns. Let me create a detailed implementation plan.
I've prepared a comprehensive implementation plan for the Aztec Aave Wrapper. Let me present the complete plan:
