 ...
 * @notice Portal contract that calls Aave directly on L1
 * @dev This contract handles cross-chain Aave integration from Aztec L2.
 *      It directly interacts with Aave on L1.
 *
 * Architecture:
